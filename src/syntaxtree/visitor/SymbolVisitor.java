...
public class SymbolVisitor implements Visitor {
    ...
    public void visit(NormalClass n) {
        ...
        for ( int i = 0; i < n.vl.size(); i++ ) {
            ...
            VarDeclaration currentVariable = n.vl.elementAt(i);
        ...
        for ( int i = 0; i < n.ml.size(); i++ ) {
            MethodDeclaration currentMethod = n.ml.elementAt(i);
            ...
            for (int j = 0; j < currentMethod.vl.size(); j++) {
                VarDeclaration currentVariable = currentMethod.vl.elementAt(j);
